...
class AdminBannerControllerTest {
    ...
    void get() {
        when(bannerService.get(1)).thenReturn(
                ResourceMeta.builder().id("r-1").build()
        );
    ...
    void createByResourceId() {
        ...
        when(bannerService.create("r-1")).thenReturn(
                ResourceMeta.builder().id("r-1").build()
        );
    ...
    void createByHash() {
        ...
        when(bannerService.createByHash("hash123")).thenReturn(
                ResourceMeta.builder().id("r-1").build()
        );
    ...
    void updateByResourceId() {
        ...
        when(bannerService.update(1, "r-1")).thenReturn(
                ResourceMeta.builder().id("r-1").build()
        );
