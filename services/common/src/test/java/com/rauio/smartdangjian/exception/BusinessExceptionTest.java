...
class BusinessExceptionTest {
    ...
    @Test
    @DisplayName("双参构造 (NOT_FOUND, message) 设置 code 为 NOT_FOUND(1) 且 message 正确")
    void constructorWithCodeAndMessageUsingNotFound() {
        BusinessException ex =
                new BusinessException(com.rauio.smartdangjian.constants.ErrorConstants.NOT_FOUND, "资源未找到");
    ...
    void extendsRuntimeException() {
        BusinessException ex =
                new BusinessException(com.rauio.smartdangjian.constants.ErrorConstants.NOT_FOUND, "test");
