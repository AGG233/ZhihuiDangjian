...
public class UserLearningRecordController {
    ...
    public ApiResponse<UserLearningRecordVO> get(@Parameter(description = "记录ID") @PathVariable Long id) {
    ...
    @PermissionAccess(UserType.STUDENT)
    public ApiResponse<List<UserLearningRecordVO>> getByUserId(@Parameter(description = "用户ID") @PathVariable Long userId) {
    ...
    public ApiResponse<List<UserLearningRecordVO>> getByChapterId(@Parameter(description = "章节ID") @PathVariable Long chapterId) {
    ...
    @PermissionAccess(UserType.STUDENT)
    public ApiResponse<List<UserLearningRecordVO>> getByUserAndChapter(
    ...
    @PostMapping("/")
    @PermissionAccess(UserType.STUDENT)
    public ApiResponse<Boolean> create(@RequestBody UserLearningRecordDto dto) {
    ...
    @PutMapping("/")
    @PermissionAccess(UserType.STUDENT)
    public ApiResponse<Boolean> update(@RequestBody UserLearningRecordDto dto) {
    ...
    @DeleteMapping("/{id}")
    @PermissionAccess(UserType.TEACHER)
    public ApiResponse<Boolean> delete(@Parameter(description = "记录ID") @PathVariable Long id) {
