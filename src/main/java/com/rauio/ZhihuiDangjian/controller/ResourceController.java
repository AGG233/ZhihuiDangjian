...
//    }
    ...
    @PostMapping(value = "/upload", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ApiResponse<Map<String, String>> uploadBatch(@RequestParam("files") List<MultipartFile> files) throws IOException, NoSuchAlgorithmException, JsonProcessingException {
    ...
    @GetMapping("/{hash}")
    public ApiResponse<URL> getByHash(@PathVariable String hash) throws JsonProcessingException {
    ...
    public ApiResponse<List<String>> getBatchByHash(@RequestBody List<String> hashList) throws JsonProcessingException {
    ...
    @GetMapping("/batch/id")
    public ApiResponse<List<String>> getBatchById(@RequestBody List<String> idList) throws JsonProcessingException {
    ...
    @DeleteMapping("/{hash}")
    public ApiResponse<Boolean> delete(@PathVariable String hash) throws JsonProcessingException {
    ...
    @DeleteMapping("/")
    public ApiResponse<Boolean> delete(@RequestParam String[] hash) throws JsonProcessingException {
        boolean result = resourceService.delete(hash);
        return ApiResponse.ok(result);
    }
}