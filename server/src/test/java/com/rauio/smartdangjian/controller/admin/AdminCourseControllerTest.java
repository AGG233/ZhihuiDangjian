...
class AdminCourseControllerTest extends BaseControllerTest {
    ...
    class NormalTests {
        ...
        void createCourseSuccess() throws Exception {
            when(courseService.create(any(CourseRequest.class))).thenReturn(true);
        ...
        void updateCourseSuccess() throws Exception {
            when(courseService.update(any(CourseRequest.class), eq("course-1"))).thenReturn(true);
    ...
    class ErrorTests {
        ...
        void createThrowsBusinessException() throws Exception {
            when(courseService.create(any(CourseRequest.class))).thenThrow(new BusinessException(4000, "课程创建失败"));
        ...
        void createThrowsRuntimeException() throws Exception {
            when(courseService.create(any(CourseRequest.class))).thenThrow(new RuntimeException("数据库连接失败"));
        ...
        void updateReturnsFalse() throws Exception {
            when(courseService.update(any(CourseRequest.class), eq("nonexistent"))).thenReturn(false);
